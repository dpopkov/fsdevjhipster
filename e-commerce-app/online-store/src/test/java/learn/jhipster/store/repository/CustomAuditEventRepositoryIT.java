package learn.jhipster.store.repository;

import learn.jhipster.store.StoreApp;

import learn.jhipster.store.config.Constants;
import learn.jhipster.store.config.audit.AuditEventConverter;
import learn.jhipster.store.domain.PersistentAuditEvent;
...
import static learn.jhipster.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
