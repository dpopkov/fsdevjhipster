package learn.jhipster.store.web.rest;

import learn.jhipster.store.StoreApp;
import learn.jhipster.store.config.Constants;
import learn.jhipster.store.domain.User;
import learn.jhipster.store.repository.AuthorityRepository;
import learn.jhipster.store.repository.UserRepository;
import learn.jhipster.store.security.AuthoritiesConstants;
import learn.jhipster.store.service.UserService;
import learn.jhipster.store.service.dto.PasswordChangeDTO;
import learn.jhipster.store.service.dto.UserDTO;
import learn.jhipster.store.web.rest.vm.KeyAndPasswordVM;
import learn.jhipster.store.web.rest.vm.ManagedUserVM;
...
import static learn.jhipster.store.web.rest.AccountResourceIT.TEST_USER_LOGIN;
